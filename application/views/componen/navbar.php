                                            ...
                                            <div class="container nav-container">
                                                ...
                                                <div class="collapse navbar-collapse" id="itech_main_menu">
                                                    <ul id="menu-menu-1" class="navbar-nav menu-open text-lg-end">
                                                        <li id="menu-item-964"
                                                            class="res-open menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor  menu-item-964">
                                                        ...
                                                        <?php if ($this->session->userdata('logged_in')): ?>
                                                            ...
                                                            <li id="menu-item-549"
                                                                class=" menu-item menu-item-type-custom menu-item-object-custom menu-item-549">
                                                                <a class="res-open" onclick="logout()">Logout</a>
                                                            </li>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.navbar-nav li a').on('click', function () {
                ...
                $('#itech_main_menu').removeClass('show');
